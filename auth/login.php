...
<head>
    ...
    <link href="<?= base_url(); ?>/_assets/css/bootstrap.min.css" rel="stylesheet">
     ...
     <style>
        ...
        body {
            background: url('<?= base_url("_assets/images/WINDOWS-MOD-3232E.png"); ?>') no-repeat center center fixed;
            background-size: cover;
        }

        /* Centered form container with a light background */
        .login-container {
        ...
        /* Add spacing and styling for the image */
        .login-container img {
            width: 100px;
            height: 100px;
            margin-bottom: 20px;
